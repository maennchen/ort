...
- [Analyzer CLI reference][analyzer] - All command-line options
- [How to exclude dirs, files, or scopes](../../how-to-guides/how-to-exclude-dirs-files-or-scopes.md) - Skip files and dependencies you don't want to analyze
- [Package curations](../../reference/configuration/package-curations.md) - Fix incorrect package metadata
