...
The `evaluator.rules.kts` file uses a Kotlin-based DSL. See the [Automate your Policy Checks tutorial](../../tutorials/automate-policy-checks.md) for a step-by-step guide to writing rules.
...
Rules can issue violations with different severities:
...
- Tutorials
  - [Automate your Policy Checks](../../tutorials/automate-policy-checks.md) - Step-by-step guide to writing rules
- Examples
