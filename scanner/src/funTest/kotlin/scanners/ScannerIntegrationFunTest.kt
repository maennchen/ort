...
class ScannerIntegrationFunTest : WordSpec({
    ...
    "Scanning a project with the same provenance as packages" should {
        ...
        "not have duplicated scan results" {
            ...
            // writeOut("src/funTest/resources/scanner-integration-shared-project-package-provenance.yml",  patchActualResult(ortResult.toYaml(), patchStartAndEndTime = true))
...
// TODO: Remove
private fun writeOut(targetFile: String, content: String) {
    val path = Paths.get(targetFile).toAbsolutePath()
